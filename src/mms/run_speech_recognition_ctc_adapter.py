...
class DataTrainingArguments:
    ...
    target_language: Optional[str] = field(
        metadata={
            "help": (
                ...
                " should be trained on in ISO 693-3 code, e.g. `ful` for Fula"
    ...
    bos_token: str = field(
        default="<s>",
        metadata={"help": "The beginning of sentence token for the tokenizer"},
    )
    eos_token: str = field(
        default="</s>",
        metadata={"help": "The end of sentence token for the tokenize"},
    )
...
def main():
    ...
    if tokenizer_name_or_path is None:
        ...
        with training_args.main_process_first():
            if data_args.overwrite_lang_vocab and os.path.isfile(vocab_file):
                try:
    ...
    # Ensure dataset audio sampling is consistent with feature extractor sampling
    ...
    # 8. Write model card and (optionally) push to hub
